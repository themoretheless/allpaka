...
set "INCLUDE=C:\Program Files (x86)\Windows Kits\10\Include\%WINSDK_VER%\ucrt;C:\Program Files (x86)\Windows Kits\10\Include\%WINSDK_VER%\shared;C:\Program Files (x86)\Windows Kits\10\Include\%WINSDK_VER%\um;C:\Program Files (x86)\Windows Kits\10\Include\%WINSDK_VER%\winrt;%INCLUDE%"
...
echo Built %OUT%\allpaka_ggml.dll
exit /b 0
