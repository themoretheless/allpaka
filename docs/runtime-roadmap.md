...
| 3 | Shared memory budget covering weights, KV, scratch and pinned cache leases | In progress: pinned prefix leases remain charged, active model replacement is rejected; unified KV/scratch admission pending |
